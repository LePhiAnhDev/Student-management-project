...
public class ThiSinh implements Serializable {
    ...
    public ThiSinh(int maThiSinh, String tenThiSinh, Tinh queQuan, Date ngaySinh, Boolean gioiTinh, float diemMon1, float diemMon2, float diemMon3, String maLop) {
